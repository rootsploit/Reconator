...
import OSINTIntel from './OSINTIntel'
...
function ScanDetails({ scan: initialScan, onBack }) {
  ...
  const tabs = [
    ...
    { id: 'attackpaths', label: 'Attack Paths', icon: 'M13 10V3L4 14h7v7l9-11h-7z' },
    { id: 'osint', label: 'OSINT Intel', icon: 'M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z' },
  ]
      ...
      <div className="tab-content">
        {loading ? (
          ...
          <>
            ...
            {activeTab === 'attackpaths' && <AttackPaths report={report} />}
            {activeTab === 'osint' && <OSINTIntel report={report} />}
          </>
        )}
      </div>
    </div>
