        ...
        <div className="login-screen">
          <div className="login-box">
            <div className="login-icon">
              <img src="/logo-full.png" alt="Reconator" style={{ width: 96, height: 96, objectFit: 'contain' }} />
            </div>
      ...
      <header className="header">
        <div className="header-logo">
          <div className="logo-icon">
            <img src="/logo.png" alt="Reconator" style={{ width: 48, height: 48, objectFit: 'contain' }} />
          </div>
          <h1>Reconator</h1>
