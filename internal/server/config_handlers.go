...
type AIConfigResponse struct {
	...
	Kimi     []APIKeyInfo     `json:"kimi"`
	Minimax  []APIKeyInfo     `json:"minimax"`
...
func (s *Server) getConfig(c *gin.Context) {
	...
	response := ConfigResponse{
		AI: AIConfigResponse{
			...
			Kimi:     maskKeyList("kimi", cfg.AI.Kimi),
			Minimax:  maskKeyList("minimax", cfg.AI.Minimax),
...
func (s *Server) testAPIKey(c *gin.Context) {
	...
	aiProviders := map[string]bool{
		...
		"google": true, "groq": true, "deepseek": true, "kimi": true,
		"moonshot": true, "minimax": true,
	}
...
func (s *Server) updateAPIKey(c *gin.Context) {
	...
	case "kimi", "moonshot":
		cfg.AI.Kimi = req.Keys
	case "minimax":
		cfg.AI.Minimax = req.Keys
	case "securitytrails":
