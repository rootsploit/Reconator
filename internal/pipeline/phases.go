...
const (
	...
	PhaseAICheckpoint1 Phase = "aicheckpoint1" // AI Checkpoint 1 (after recon, before ports)
	PhaseAICheckpoint2 Phase = "aicheckpoint2" // AI Checkpoint 2 (after ports/WAF, before scanning)
)
...
var PhaseNumber = map[Phase]int{
	...
	PhaseScreenshot:    11,
	PhaseAIGuided:      12,
	PhaseAICheckpoint1: 13, // AI checkpoint between recon and scanning
	PhaseAICheckpoint2: 14, // AI checkpoint between infrastructure and vuln scanning
}
...
var PhaseName = map[Phase]string{
	...
	PhaseWAF:           "WAF Enrichment (Origin IPs)",
	PhasePorts:         "WAF + Port + HTTPx",
	...
	PhaseAICheckpoint1: "AI Checkpoint 1 (Recon Analysis)",
	PhaseAICheckpoint2: "AI Checkpoint 2 (Scan Strategy)",
}
...
var PhaseDependencies = map[Phase][]Phase{
	...
	PhaseScreenshot:    {PhasePorts},                                            // Run early before aggressive scans trigger WAF blocks
	PhaseAIGuided:      {PhasePorts, PhaseTech, PhaseVulnScan, PhaseSecHeaders}, // SecHeaders for summary
	PhaseAICheckpoint1: {PhaseSubdomain, PhaseHistoric, PhaseJSAnalysis},        // Reviews recon surface
	PhaseAICheckpoint2: {PhasePorts, PhaseWAF, PhaseTech},                       // Optimizes scan strategy based on infrastructure
}
...
var PhaseProduces = map[Phase][]string{
	...
	PhaseWAF:           {"origin_ips", "waf_fingerprints"},
	PhasePorts:         {"alive_hosts", "open_ports", "tls_info", "cdn_hosts", "direct_hosts", "cdn_details"},
	...
	PhaseAICheckpoint1: {"prioritized_hosts", "adaptive_wordlist", "skip_phases"},
	PhaseAICheckpoint2: {"nuclei_tags", "host_scan_strategy", "custom_dir_words"},
}
